...
namespace Ra.Trail
{
    public class TrailObject<T> : TrailObject where T : TrailObject, new()
    {
        ...
        public override void Initialize(MonoTrail newMonoTrail = null)
        {
            monoTrail = newMonoTrail == null ? CreateMonoTrail() : newMonoTrail;
        ...
        /// <returns></returns>
        public T Direct(WorkOptions options)
        {
            DirectWork(options);
            return this as T;
        }
        ...
        /// <returns></returns>
        public T PrintAll<Z>(List<Z> textList = null)
        {
            PrintAll(() => textList);
            return this as T;
        }
        ...
        /// <summary>
        /// Continue execution from specified label.
        /// </summary>
        /// <param name="labelName"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Execute children during operation.
        /// </summary>
        /// <returns></returns>
        public T After()
        {
        ...
        /// <summary>
        /// Execute children independently from the sequence.
        /// </summary>
        /// <returns></returns>
        public T Parallel()
        {
        ...
        /// <summary>
        /// Create a new part in Alternative.
        /// </summary>
        /// <param name="customChangeDelay"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Execute a function every frame.
        /// </summary>
        ...
        /// <summary>
        /// Execute children every fixed framerate frame.
        /// </summary>
        /// <returns></returns>
        public T FixedLoop()
        {
        ...
        /// <summary>
        /// Execute a function every fixed framerate frame.
        /// </summary>
        /// <param name="inFixedLoop"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Access variables and labels contained in a namespace.
        /// </summary>
        /// <param name="namespaceName"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Increase a value of a variable.
        /// </summary>
        /// <param name="varName"></param>
        /// <param name="action"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Copy the value of the variable to another variable at runtime.
        /// </summary>
